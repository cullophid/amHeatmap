                ...
                link: function postLink(scope, element, attrs) {
                    ...
                    function processData(data) {
                        var matrix, i, scaleX, scaleY,
                            ...
                            t1 = new Date().getTime();
                        // heatmap.setDataSet({}); 
                        scaleX = element.width() / data.cols;
                        scaleY = element.height() / data.rows;
                        for (i = 0; i < data.data.length; i += 1) { // iterate columns
                            dataSet.data.push({
                                x: data.data[i].x * scaleX,
                                y: data.data[i].y * scaleY,
                    ...
                    // heatmap.store.addDataPoint(190, 120);
                    console.log(processData(scope.data));
                    heatmap.store.setDataSet(processData(scope.data));
                }
            }
        }
    ]);